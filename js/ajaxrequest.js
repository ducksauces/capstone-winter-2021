...
function search(data, query) {
    ...
    var numResults = (Object.keys(results).length + " item(s) for \"" + query + "\"");
...
function showResults(brand) {
    $.ajax({
        ...
        success: function (data) {
            ...
            var numResults = (Object.keys(results).length + " item(s) in brand '" + brand + "'");
            $("#numResults").html(numResults);
        }
    });
}
...
function showTypes(type) {
    $.ajax({
        ...
        success: function (data) {
            ...
            var numResults = (Object.keys(results).length + " item(s) in type '" + type + "'");
            $("#numResults").html(numResults);
        }
    });
}
